...
#mode(xm)
#mode(ym)
heatmap.2(as.matrix(x), lwid=lwid, Rowv = as.dendrogram(otu.clus), Colv = as.dendrogram(samples.clus), col = colscale,margins=c(xm,ym), ColSideColors = group1,trace=c("none"),srtCol=90,key=FALSE)
dev.off()
